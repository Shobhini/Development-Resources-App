      ...
      <div className="flex flex-col gap-6 pt-2">
        <NavLink to="/">
          <div className="group flex flex-col gap-3 justify-center items-center">
            <FaHome className="text-[#e2afaf]  hover:text-grape-100 group-hover:scale-125 duration-200" />
        ...
        <NavLink to="/Tools">
          <div className="group flex flex-col gap-3 justify-center items-center">
            <BsTools className="text-[#e6dddd] hover:text-grape-100 group-hover:scale-125 duration-200" />
            <h6 className="text-grape-100 text-xs opacity-0 group-hover:opacity-100 text-[white]">
              Tools
            </h6>
          </div>
