    ...
    <div className="flex flex-col w-full h-screen mt-6">
      ...
      >
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
          About Development Resources Hub
        </h1>
        
        <div className="space-y-6 text-gray-600 dark:text-gray-300">
          <p>
            Welcome to Development Resources Hub, your comprehensive platform for development
            ...
            world of web/android development.
          </p>
          ...
          <p>
            ...
            Our platform curates the best development resources, from beginner-friendly
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Regular updates with the latest development trends</li>
          </ul>
          ...
          <p>
            ...
            experienced developer looking to stay updated, Development Resources Hub is here
